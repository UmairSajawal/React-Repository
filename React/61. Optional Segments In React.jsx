    ...
    return (
        ...
        <div>
            ...
            {/* <Route element={<NavBar />}> */}
                ...
                <Route path="/user/list?" element={<UserList />} /> {/* Note:  ? means Static Optional segment*/}
                <Route path="/user/:id/:name?" element={<UserData />} /> {/* Note:  ? means Dynamic Optional segment*/}
                {/*<Route path="pk">
                    <Route path="/pk/user">
